...
# iimg = Image.open("a.png")
apikey = 'sk-8qoj2JzrT22eJIck4u9QbMsu1xY1af5GMR3VCZHJrPiQsBn6'

stability_api = client.StabilityInference(
  key=apikey,  # API Key reference.
...
answers = stability_api.generate(
  ...
  steps=
  15,  # Amount of inference steps performed on image generation. Defaults to 30. 
  cfg_scale=
